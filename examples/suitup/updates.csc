...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/suitup/update-server.c</source>
      <commands>make update-server.cooja TARGET=cooja</commands>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/suitup/update-client.c</source>
      <commands>make update-client.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <mote>
      <interface_config>
        ...
        <x>74.77063432318738</x>
        <y>98.37617167561767</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>60.49495058207059</x>
        <y>99.7277246883141</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>24.708257700564516 0.0 0.0 24.708257700564516 -1477.0884649283519 -2274.401061422976</viewport>
    </plugin_config>
    <width>400</width>
    <z>2</z>
    <height>400</height>
